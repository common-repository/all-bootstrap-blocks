<?php  
$styles = '
	#' . lightspeed_get_block_id() . ' .areoi-footer-phone a {
...
<?php  
$row_columns = $include_company ? $main_menu_columns - 1 : $main_menu_columns;
...
<div class="areoi-footer-strip">
	<div class="<?php echo $container ?>">
		...
		<?php if ( $include_logo || $include_social ) : ?>
...
<div class="areoi-footer-strip">
	<div class="<?php echo $container ?>">
		...
		<div class="row pt-5 pb-5 areoi-footer-main-menu">
