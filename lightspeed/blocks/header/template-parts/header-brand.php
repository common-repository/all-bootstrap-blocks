<div class="areoi-header-brand h-100">
	<div class="mb-0 h-100">
		<a class="h-100" href="<?php echo home_url() ?>" title="<?php echo get_bloginfo( 'name' ) ?>">
			<?php if ( !empty( lightspeed_get_logo( lightspeed_get_attribute( 'logo', null ), lightspeed_get_attribute( 'logo_color', 'dark' ) ) ) ) : ?>
				<div class="position-relative">
					<div class="areoi-header-brand-default">
						<?php echo lightspeed_get_logo( lightspeed_get_attribute( 'logo', null ), lightspeed_get_attribute( 'logo_color', 'dark' ) ) ?>
					</div>
					<div class="areoi-header-brand-scroll position-absolute top-0 start-0">
						<?php echo lightspeed_get_logo( lightspeed_get_attribute( 'logo', null ), lightspeed_get_attribute( 'logo_color_scroll', 'dark' ) ) ?>
					</div>
				</div>
			<?php else : ?>
