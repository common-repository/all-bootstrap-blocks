...
class AREOI_HAF_Walker_Nav_Menu_More extends Walker_Nav_Menu 
{
    public function start_lvl( &$output, $depth = 0, $args = null ) 
    {
        ...
        $back = '<button type="button" class="areoi-offcanvas-back">
        ...
        $output .= "{$n}{$indent}<div class=\"offcanvas-body offcanvas-body-main\">
            $back
            <ul$class_names>{$n}";
    }
    ...
    public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) 
    {
        ...
        $dropdown = ( $args->walker->has_children ) ? ' <button type="button">
