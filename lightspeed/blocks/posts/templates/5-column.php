...
<div class="container h-100 position-relative">
	<div class="row h-100 align-items-center">
		...
		<div class="col">
			...
			<div class="row row-cols-1 row-cols-md-2 row-cols-lg-5 justify-content-<?php echo lightspeed_get_attribute( 'content_alignment', 'start' ) == 'center' ? 'center' : lightspeed_get_attribute( 'alignment' ) ?> <?php echo 'text-' . lightspeed_get_attribute( 'content_alignment', 'start' ) ?>">
